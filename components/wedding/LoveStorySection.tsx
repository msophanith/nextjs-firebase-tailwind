    ...
    <section className="py-20 px-4 bg-white relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="relative">
          ...
          <div className="absolute left-4 sm:left-1/2 transform sm:-translate-x-1/2 h-full w-0.5 bg-[#D4AF37]/20"></div>

          <div className="space-y-12 sm:space-y-24">
            {/* Story Item 1 */}
            <div className="relative flex flex-col sm:flex-row items-center justify-between gap-8 group">
